    ...
    <main>
      ...
      <section className="bg-[#1A1A1A] text-white py-14 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="font-bold text-3xl sm:text-5xl tracking-tight mb-3">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-4 items-stretch md:items-center">
          ...
          <div className="flex items-center justify-between gap-4 w-full md:w-auto">
            ...
            <select
              ...
              className="border border-black/10 rounded-full px-4 py-2 text-sm outline-none focus:border-[#1B87C8] bg-white transition-colors flex-1 md:flex-initial"
            >
              {ORDENAMIENTO.map((o) => (
