    ...
    <main>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          >
            57 años siendo <br />la ferretería de <span style={{ color: "#F5A623" }}>confianza</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              { icon: "🤝", title: "Trato familiar", desc: "57 años de servicio honesto y personalizado a las familias de Recreo y la región." },
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-5 text-center">
          {[
            { num: "57+", label: "Años de historia", icon: "🏆" },
